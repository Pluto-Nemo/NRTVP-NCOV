...
while True:
    ...
    if time_now == "04:00":
        ...
        china_simplify.to_file('../json/china_simplify.geojson', driver='GeoJSON', encoding='gb18030')
        provinceNew.to_json('../json/province_New.json',orient='index',force_ascii=False)
        provinceConfirm.to_json('../json/province_Confirm.json',orient='index',force_ascii=False)
        ...
        city_simplify.to_file('../json/city_simplify.geojson',driver='GeoJSON',encoding='gb18030')
